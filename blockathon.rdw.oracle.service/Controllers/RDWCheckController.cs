...
namespace blockathon.rdw.oracle.service.Controllers
{
    ...
    public class RDWCheckController : ControllerBase
    {
        public RDWCheckController(ILogger<RDWCheckController> logger, ISmartContract smartContract) : base(logger, smartContract)
        { }
